           ...
           <div class="col-xl-8 col-lg-8 m-auto">
               <div class="card">
                   <div class="card-header ">
                       <h4 class="card-title text-center m-auto ">Add coupon</h4>
                   </div>
                   <div class="card-body">
                       <div class="basic-form">
                           <form method="POST" action="{{route('admincoupon.store')}}" >
                            @csrf
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="number" name="coupon_percentige" class="form-control" >
                                   </div>
                               </div>
                               <div class="form-group row">
                                   <label class="col-sm-3 col-form-label">Coupon validaty</label>
                                   <div class="col-sm-9">
                                       <input type="date" name="validaty" class="form-control" >
                                   </div>
                               </div>
                               <div class="form-group row">
