								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> Products</p>
												<span class="title text-black font-w600">{{allproducts()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> Subscribers</p>
												<span class="title text-black font-w600">{{subscribers()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2"> coupons</p>
												<span class="title text-black font-w600">{{coupons()->count()}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
								...
								<div class="card">
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										<div class="mr-auto pr-3">
											<h4 class="text-black font-w600 fs-20">All Customers <span class="text-danger">{{users()->count()}}</span></h4>
